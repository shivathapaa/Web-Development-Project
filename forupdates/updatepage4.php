        ...
        <section class="tablebox">
            <div class="tablesplit">
                <div class="tablecontent">
                    ...
                    <a href="http://localhost/AutomobileWebProject/adminorders.php"><button type="button">Check Table</button></a>
                ...
                <div class="update-table">
                    ...
                    <?php
                        ...
                        $sql = "SELECT * FROM orderpage22 WHERE sn = {$ids}";
                        $result = $conn->query($sql);
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            $query = "update orderpage22 set customerid='$customerid', electricalengine ='$electricalengine', thermalengine='$thermalengine' WHERE sn = $idupdate ";
                    ...
                    ?>
                        ...
                        <p>Electrical Engine</p>
                        <datalist id="electricalengine1">
                            <option value="Ion Drives Electrical Engine">
                            <option value="EM/Cannae Drives Electrical Engine">
                        </datalist>
                        <datalist id="thermal">
                            <option value="Internal Combustion Engine">
                            <option value="External Combustion Engine">
                        </datalist>
                        <input type="text" placeholder="Enter electricalengine" name="electricalengine" list="electricalengine1" value="<?php echo $dataall["electricalengine"] ?>"><br>
                        <p>Thermal Engine</p>
                        <input type="text" placeholder="Enter thermalengine" list="thermal" name="thermalengine" value="<?php echo $dataall["thermalengine"] ?>"><br>
