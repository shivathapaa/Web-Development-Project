            ...
            <div class="tablesplit">
                ...
                <div class="update-table">
                    ...
                    <?php
                        ...
                        $sql = "SELECT * FROM ordermanufacturer WHERE sn = {$ids}";
                        $result = $conn->query($sql);
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            $query = "update ordermanufacturer set customerid='$customerid', country ='$country', manufacturerid='$manufacturerid', automobiletype='$automobiletype' WHERE sn = $idupdate ";
                    ...
                    ?>
                        ...
                        <p>Country</p>
                        <input type="text" placeholder="Enter Country" name="country" value="<?php echo $dataall["country"] ?>"><br>
                        <p>Manufacturer ID</p>
                        <input type="text" placeholder="Enter Manufacturer ID" list="manufacturerid" name="manufacturerid" value="<?php echo $dataall["manufacturerid"] ?>"><br>
                        ...
                        <p>Contact</p>
                        <input type="text" placeholder="Enter Automobile Type" list="automobiletype" name="automobiletype" value="<?php echo $dataall["automobiletype"] ?>"><br>
