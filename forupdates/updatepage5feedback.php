        ...
        <section class="tablebox">
            <div class="tablesplit">
                <div class="tablecontent">
                    ...
                    <a href="http://localhost/AutomobileWebProject/adminfeedback.php"><button type="button">Check Table</button></a>
                ...
                <div class="update-table">
                    ...
                    <?php
                        ...
                        $sql = "SELECT * FROM feedback24 WHERE sn = {$ids}";
                        $result = $conn->query($sql);
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            $query = "update feedback24 set emailid ='$emailid', fullname ='$fullname', message='$message' WHERE sn = $idupdate ";
                            ...
                            if ($ress){
                                ...
                                <script>
                                    ...
                                    location.replace("http://localhost/AutomobileWebProject/adminfeedback.php");
                                </script>
                                <?php
                            }else{
                                ?>
                    ...
                    ?>
                        ...
                        <p>Email ID</p>
                        <input type="text" placeholder="Enter Email ID" name="emailid" value="<?php echo $dataall["emailid"] ?>"><br>
                        <p>Full Name</p>
                        <input type="text" placeholder="Enter Full Name" name="fullname" value="<?php echo $dataall["fullname"] ?>"><br>
                        <p>Message</p>
                        <input type="text" placeholder="Message" name="message" value="<?php echo $dataall["message"] ?>"><br>
