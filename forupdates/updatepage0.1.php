                ...
                <div class="update-table">
                    ...
                    <?php
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            $query = "update signuppage51 set email='$email', contact='$contact', fulladdress ='$fulladdress' WHERE s_no = $idupdate ";
                    ...
                    ?>
                        ...
                        <p>Full Address</p>
                        <input type="text" placeholder="Enter Full Address" name="fulladdress" value="<?php echo $dataall["fulladdress"] ?>"><br>
