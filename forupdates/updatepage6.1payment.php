...
<div class="sidebar">
    <div class="sidebar-header">
        <h3 class="brand">
        <a  href="../../index.php"><span class="name">Two Flames</span></a>
        </h3>
        ...
        <section class="tablebox">
            <div class="tablesplit">
                <div class="tablecontent">
                    ...
                    <a href="../adminpaymentdetails.php"><button type="button">Check Table</button></a>
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            if ($ress){
                                ...
                                <script>
                                    ...
                                    location.replace("../adminpaymentdetails.php");
                                </script>
                                <?php
                            }else{
                                ?>
