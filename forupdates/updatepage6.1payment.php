...
.class-table input[type="text"], .class-table input[type="date"]{
    border: none;
...
<div class="sidebar">
    ...
    <div class="sidebar-menu">
        <ul>
            ...
            <li><a href="http://localhost/AutomobileWebProject/adminconn.php">
                    <span class="fa fa-bar-chart"></span>
                    <span>Overview</span>
                </a>
            </li>
            <li><a href="http://localhost/AutomobileWebProject/adminorders.php">
                    <span class="ti-clipboard"></span>
                    <span>Orders</span>
                </a>
            </li>
            <li><a href="http://localhost/AutomobileWebProject/admindelivery.php">
                    <span class="fa fa-shopping-cart"></span>
                    <span>Delivery</span>
                </a>
            </li>
            <li><a href="http://localhost/AutomobileWebProject/adminpaymentdetails.php">
        ...
        <section class="tablebox">
            <div class="tablesplit">
                <div class="tablecontent">
                    ...
                    <a href="http://localhost/AutomobileWebProject/adminpaymentdetails.php"><button type="button">Check Table</button></a>
                ...
                <div class="update-table">
                    ...
                    <?php
                        ...
                        $sql = "SELECT * FROM paymentdetails WHERE sn = {$ids}";
                        $result = $conn->query($sql);
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            $query = "update paymentdetails set customerid='$customerid', cname ='$cname', ccnum='$ccnum', expmonth='$expmonth', expyear='$expyear', cvv='$cvv' WHERE sn = $idupdate ";
                            ...
                            if ($ress){
                                ...
                                <script>
                                    ...
                                    location.replace("http://localhost/AutomobileWebProject/adminpaymentdetails.php");
                                </script>
                                <?php
                            }else{
                                ?>
                    ...
                    ?>
                        ...
                        <p>Customer ID</p>
                        <input type="text" placeholder="Enter Customer ID" name="customerid" value="<?php echo $dataall["customerid"] ?>"><br>
                        <p>Card Holder Name</p>
                        <input type="text" placeholder="Enter Card Holder Name" name="cname" value="<?php echo $dataall["cname"] ?>"><br>
                        <p>Credit Card Number</p>
                        <input type="text" placeholder="Enter Credit Card Number" name="ccnum" value="<?php echo $dataall["ccnum"] ?>"><br>
                        <p>Expiry Month</p>
                        <input type="text" placeholder="Enter Expiry Month" name="expmonth" value="<?php echo $dataall["expmonth"] ?>"><br>
                        <p>Expiry Year</p>
                        <input type="date" placeholder="Enter Expiry Year" name="expyear" value="<?php echo $dataall["expyear"] ?>"><br>
                        <p>Card Verification Value</p>
                        <input type="text" placeholder="Enter Card Verification Value" name="cvv" value="<?php echo $dataall["cvv"] ?>"><br>
