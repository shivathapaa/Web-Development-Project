        ...
        <section class="tablebox">
            <div class="tablesplit">
                <div class="tablecontent">
                    ...
                    <a href="http://localhost/AutomobileWebProject/adminconn.php"><button type="button">Check Table</button></a>
                ...
                <div class="update-table">
                    ...
                    <?php
                        ...
                        $sql = "SELECT * FROM signuppage51 WHERE s_no = {$ids}";
                        $result = $conn->query($sql);
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            // $insertquery = "insert into signuppage51(firstname, lastname, email) values('$firstname', '$lastname', '$email')";

                            $query = "update signuppage51 set firstname='$firstname', lastname ='$lastname', email='$email', contact='$contact' WHERE s_no = $idupdate ";
                    ...
                    ?>
                        ...
                        <p>First Name</p>
                        <input type="text" placeholder="Enter First Name" name="firstname" value="<?php echo $dataall["firstname"] ?>"><br>
                        <p>Last Name</p>
                        <input type="text" placeholder="Enter Last Name" name="lastname" value="<?php echo $dataall["lastname"] ?>"><br>
                        <p>Email</p>
                        <input type="text" placeholder="Enter Email ID" name="email" value="<?php echo $dataall["email"] ?>"><br>
                        <p>Contact</p>
                        <input type="text" placeholder="Enter Contact no." name="contact" maxlength="14" value="<?php echo $dataall["contact"] ?>"><br>
