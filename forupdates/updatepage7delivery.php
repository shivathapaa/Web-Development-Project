        ...
        <section class="tablebox">
            <div class="tablesplit">
                <div class="tablecontent">
                    ...
                    <a href="http://localhost/AutomobileWebProject/admindelivery.php"><button type="button">Check Table</button></a>
                ...
                <div class="update-table">
                    ...
                    <?php
                        ...
                        $sql = "SELECT * FROM delivery23 WHERE sn = {$ids}";
                        $result = $conn->query($sql);
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            $query = "update delivery23 set customerid ='$customerid', deliverylocation ='$deliverylocation', deliverytype ='$deliverytype', deliverydate='$deliverydate', deliverytime='$deliverytime' WHERE sn = $idupdate ";
                    ...
                    ?>
                        ...
                        <p>Delivery Type</p>
                        <input type="text" placeholder="Enter Delivery Type" name="deliverytype" value="<?php echo $dataall["deliverytype"] ?>"><br>
                        <p>Delivery Location</p>
                        <input type="text" placeholder="Enter Delivery Location" name="deliverylocation" value="<?php echo $dataall["deliverylocation"] ?>"><br>
                        <p>Delivery Date</p>
                        <input type="date" placeholder="Enter Delivery Date" name="deliverydate" value="<?php echo $dataall["deliverydate"] ?>"><br>
                        <p>Delivery Time</p>
                        <input type="time" placeholder="Enter Delivery Time" name="deliverytime" value="<?php echo $dataall["deliverytime"] ?>"><br>
