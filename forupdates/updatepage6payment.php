...
<div class="sidebar">
    ...
    <div class="sidebar-menu">
        <ul>
            ...
            <li><a href="http://localhost/adminfeedback.php">
                    <span class="ti-comment"></span>
                    <span>Feedback</span>
                </a>
            </li>
            <li><a href="http://localhost/adminprojectpages.php">
                ...
                <div class="update-table">
                    ...
                    <?php
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            $query = "update paymentdetails set customerid='$customerid', fullname ='$fullname', email='$email', aadress='$aadress', sstate='$sstate', zip='$zip' WHERE sn = $idupdate ";
                    ...
                    ?>
                        ...
                        <p>Full Name</p>
                        <input type="text" placeholder="Enter Fullname" name="fullname" value="<?php echo $dataall["fullname"] ?>"><br>
                        <p>Email</p>
                        <input type="text" placeholder="Enter Email" name="email" value="<?php echo $dataall["email"] ?>"><br>
                        <p>Address</p>
                        <input type="text" placeholder="Enter Address" name="aadress" value="<?php echo $dataall["aadress"] ?>"><br>
                        <p>State</p>
                        <input type="text" placeholder="Enter State" name="sstate" value="<?php echo $dataall["sstate"] ?>"><br>
                        <p>Zip Code</p>
                        <input type="text" placeholder="Enter Zip Code" name="zip" value="<?php echo $dataall["zip"] ?>"><br>
