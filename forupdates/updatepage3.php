            ...
            <div class="tablesplit">
                ...
                <div class="update-table">
                    ...
                    <?php
                        ...
                        $sql = "SELECT * FROM orderpage21 WHERE sn = {$ids}";
                        $result = $conn->query($sql);
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            $query = "update orderpage21 set customerid='$customerid', model ='$model', chassis='$chassis', engine='$engine', transmission='$transmission' WHERE sn = $idupdate ";
                    ...
                    ?>
                        ...
                        <p>Model</p>
                        <input type="text" placeholder="Enter Model" name="model" list="mod" value="<?php echo $dataall["model"] ?>"><br>
                        <p>Chassis</p>
                        <input type="text" placeholder="Enter Chassis" list="chass" name="chassis" value="<?php echo $dataall["chassis"] ?>"><br>
                        <p>Engine</p>
                        <input type="text" placeholder="Enter Engine" list="eng" name="engine" value="<?php echo $dataall["engine"] ?>"><br>
                        <p>Transmission</p>
                        <input type="text" placeholder="Enter Transmission" list="trans" name="transmission" value="<?php echo $dataall["transmission"] ?>"><br>
                        <datalist id="mod">
                            <option value="SUVs">
                            <option value="Sports">
