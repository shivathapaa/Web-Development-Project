    ...
    *{
    ...
    @media only screen and (max-width: 450px){
        ...
        <div class="main-content">
            ...
            <header>
                <div class="welcome"><p>Welcome Admin <?php echo $_SESSION['adminfirstname']; ?>!</p></div>
                                    ...
                                    <?php
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result-> fetch_assoc()){
                                                $number = $row["s_no"];
                                                echo "<tr><td>" . $row["s_no"] . "</td><td>" . $row["firstname"] . "</td><td>" . $row["lastname"] . "</td><td>" . $row["email"] . "</td><td>" . $row["contact"] . "</td>";
                                                $n = $n + 1 ;
                                                ?>                                          
                                                <td>
                                                <?php
                                                ...
                                                ?>
                                            <td>
                                                <a href="forupdates/updatepage.php?id=<?php echo $row["s_no"]; ?>" data-toggle="tooltip" data-placement="buttom" title="Update"><span class="badge success"><i class="fa fa-pencil-square-o"></i></span></a>&nbsp;&nbsp;&nbsp;<a href="forupdates/deletepage.php?id=<?php echo $row["s_no"]; ?>" data-toggle="tooltip" data-placement="buttom" title="Delete"><span class="badge success"><i class="fa fa-trash" aria-hidden="true"></i></span></a>
                                            </td>
                                            </tr>
                                                <?php 
                                                }else{
                                                ...
                                                ?>
                                                <td>
                                                    <a href="forupdates/updatepage.php?id=<?php echo $row["s_no"]; ?>" data-toggle="tooltip" data-placement="buttom" title="Update"><span class="badge warning"><i class="fa fa-pencil-square-o"></i></span></a>&nbsp;&nbsp;&nbsp;<a href="forupdates/deletepage.php?id=<?php echo $row["s_no"]; ?>" data-toggle="tooltip" data-placement="buttom" title="Delete"><span class="badge warning"><i class="fa fa-trash" aria-hidden="true"></i></span></a>
                                                </td>
                                            </tr>
                                        <?php
                                                }
                                ...
                                <table id="table">
                                    ...
                                    <?php
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result-> fetch_assoc()){
                                                $number = $row["s_no"];
                                                echo "<tr><td>" . $row["s_no"] . "</td><td>" . $row["email"] . "</td><td>" . $row["contact"] . "</td><td>" . $row["fulladdress"] . "</td>" ;
                                                $n = $n + 1 ;
                                                ?>                                          
                                                <?php
                                                if($n % 2 != 0){
                                                ...
                                                ?>
                                            <td>
                                                <a href="forupdates/updatepage0.1.php?id=<?php echo $row["s_no"]; ?>" data-toggle="tooltip" data-placement="buttom" title="Update"><span class="badge success"><i class="fa fa-pencil-square-o"></i></span></a>&nbsp;&nbsp;&nbsp;<a href="forupdates/deletepage.php?id=<?php echo $row["s_no"]; ?>" data-toggle="tooltip" data-placement="buttom" title="Delete"><span class="badge success"><i class="fa fa-trash" aria-hidden="true"></i></span></a>
                                            </td>
                                            </tr>
                                                <?php 
                                                }else{
                                                ...
                                                ?>
                                                <td>
                                                    <a href="forupdates/updatepage0.1.php?id=<?php echo $row["s_no"]; ?>" data-toggle="tooltip" data-placement="buttom" title="Update"><span class="badge warning"><i class="fa fa-pencil-square-o"></i></span></a>&nbsp;&nbsp;&nbsp;<a href="forupdates/deletepage.php?id=<?php echo $row["s_no"]; ?>" data-toggle="tooltip" data-placement="buttom" title="Delete"><span class="badge warning"><i class="fa fa-trash" aria-hidden="true"></i></span></a>
                                                </td>
                                            </tr>
                                        <?php
                                                }
