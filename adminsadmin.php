...
@media only screen and (max-width: 450px){
    ...
    <div class="main-content">
        ...
        <main>
            ...
            <h2 class="dash-title">Admin Details</h2>
            ...
            <div class="dash-cards">
                ...
                <div class="card-single">
                    ...
                    <div class="card-footer">
                        <a href="adminfeedback.php">View all</p></a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="table-responsive">
                            <table id="table">
                                ...
                                <?php
                                    ...
                                    $conn = mysqli_connect($host, $dbUsername, $dbPassword, $dbname);
                                    $sql = "SELECT * FROM adminlogin ORDER BY sn";
                                    $result = $conn->query($sql);
                                    $n = 0;

                                    if ($result->num_rows > 0) {
                                        while ($row = $result-> fetch_assoc()){
                                            echo "<tr><td>" . $row["sn"] . "</td><td>" . $row["adminfirstname"] . "</td><td>" . $row["adminlastname"] . "</td><td>" . $row["adminid"] . "</td><td>" . $row["contact"] . "</td><td>" . $row["fulladdress"] . "</td>";
                                            $n = $n + 1 ;
                                            ?>
                                            <?php
                                            if($n % 2 != 0){
                                            ...
                                            ?>
                                        <td>
                                            <a href="forupdates/update8adminsignup.php?id=<?php echo $row["sn"]; ?>" data-toggle="tooltip" data-placement="buttom" title="Update"><span class="badge success"><i class="fa fa-pencil-square-o"></i></span></a>&nbsp;&nbsp;&nbsp;<a href="forupdates/deletepage8adminsignup.php?id=<?php echo $row["sn"]; ?>" data-toggle="tooltip" data-placement="buttom" title="Delete"><span class="badge success"><i class="fa fa-trash" aria-hidden="true"></i></span></a>
                                        </td>
                                        </tr>
                                            <?php 
                                            }else{
                                            ...
                                            ?>
                                            <td>
                                                <a href="forupdates/update8adminsignup.php?id=<?php echo $row["sn"]; ?>" data-toggle="tooltip" data-placement="buttom" title="Update"><span class="badge warning"><i class="fa fa-pencil-square-o"></i></span></a>&nbsp;&nbsp;&nbsp;<a href="forupdates/deletepage8adminsignup.php?id=<?php echo $row["sn"]; ?>" data-toggle="tooltip" data-placement="buttom" title="Delete"><span class="badge warning"><i class="fa fa-trash" aria-hidden="true"></i></span></a>
                                            </td>
                                        </tr>
                                    <?php
                                            }
